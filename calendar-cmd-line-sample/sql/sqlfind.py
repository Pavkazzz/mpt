# -*- coding: utf-8 -*-
from sql import Teacher, Discipline, Session, Gruppa, AbstractPara
...
for para in excel:
    ...
    number_week = int(para[-2])
    # Узнаем номер пары
    number_para = int(para[-1])

    sqlabspara = AbstractPara(teacherstate, disciplinestate, gruppastate, number_para, daysofweek, number_week)
